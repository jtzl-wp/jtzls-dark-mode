 ...
 *
 * @package JTZL\JTZL_Dark_Mode\Services
 */

declare(strict_types=1);

namespace JTZL\JTZL_Dark_Mode\Services;

// Exit if accessed directly.
defined( 'ABSPATH' ) || exit;

use JTZL\JTZL_Dark_Mode\Contracts\FilterServiceInterface;
...
class FilterService implements FilterServiceInterface {
	 ...
	 *
	 * Filter: jtzl_dark_mode_css_variables
	...
	public function get_filtered_css_variables(): array {
		$variables = apply_filters( 'jtzl_dark_mode_css_variables', self::DEFAULT_CSS_VARIABLES );
